...
public class Program {
	public static void category() {
		...
		do {
			...
			case 2:
				category.input();
				boolean checkInsert = cateDAO.add(category);
				if (checkInsert) {
			...
			case 4:
				...
				category.input();
				boolean checkDelete = cateDAO.remove(category);
				if (checkDelete) {
	...
	public static void product() {
		...
		do {
			...
			case 2:
				product.input();
				boolean checkInsert = proDAO.add(product);
				if (checkInsert) {
			...
			case 4:
				System.out.print("Nhập thông tin cần xóa: \n");
				product.input();
				boolean checkDelete = proDAO.remove(product);
				if (checkDelete) {
